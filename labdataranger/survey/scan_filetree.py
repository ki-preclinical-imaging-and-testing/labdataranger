...
from labdataranger.metadata__scan.metadata__session import ImagingSessionMetadata
...
def main():
    parser = argparse.ArgumentParser(description="Scan a filetree and extract metadata.")
